...
/** Hand-rolled icons — a full icon library would be far more weight than four glyphs need. */
...
export function DownloadIcon({ className, size = 15 }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M17 21H7a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5.586a1 1 0 0 1 .707.293l5.414 5.414a1 1 0 0 1 .293.707V19a2 2 0 0 1-2 2Z" />
    </svg>
  );
}
...
export function PinIcon({ className, size = 13 }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M12 21c-4.97-5.457-7.5-9.22-7.5-12a7.5 7.5 0 0 1 15 0c0 2.78-2.53 6.543-7.5 12Z" />
